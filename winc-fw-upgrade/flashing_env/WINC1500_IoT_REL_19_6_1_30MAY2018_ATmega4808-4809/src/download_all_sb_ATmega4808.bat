...
echo With:    nedbg ATmega4808 Tools\ATmega4808_xplained_pro_serial_bridge\atmega4808_serial_bridge.elf ATmega 3A0 %SN% 0 0 %*
echo.
call download_all_sb.bat nedbg ATmega4808 Tools\ATmega4808_xplained_pro_serial_bridge\atmega4808_serial_bridge.elf ATmega 3A0 %SN% 0 0 %*
