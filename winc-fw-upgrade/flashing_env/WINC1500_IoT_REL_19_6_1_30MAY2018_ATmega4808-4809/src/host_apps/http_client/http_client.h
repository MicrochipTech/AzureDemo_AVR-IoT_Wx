...
#define HTTP_CLIENT_DOWNLOAD_STARTING						(0)
#define HTTP_CLIENT_DOWNLOAD_COMPLETE						(1)
#define HTTP_CLIENT_CONNECTION_ERROR						(-100)
#define	HTTP_CLIENT_SERVER_ERROR							(-101)
...
#define HTTP_CLIENT_RX_BUFFER_MAX					(1400)
...
HTTPClientHandle HTTP_ClientDownload(char *pcTargetURL, tpfHttpClientNotificationCallback fpCb, uint32 u32UsrData);
