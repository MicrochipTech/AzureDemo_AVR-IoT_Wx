...
#define HTTP_CLIENT_FINISHED								(-2)
#define HTTP_CLIENT_DOWNLOADING								(-3)
#define HTTP_CLIENT_CONNECTION_ERROR						(-100)

#define HTTP_PORT									(80)
#define HTTPS_PORT									(443)
#define HTTP_CLIENT_FILE_NAME_MAX					(64)
#define HTTP_CLIENT_HOST_NAME_MAX					(64)
#define HTTP_CLIENT_RX_BUFFER_MAX					(128)
#define HTTP_CLIENT_HEADER_MAX						(32)
...
typedef struct{
	uint8		pu8Field[HTTP_CLIENT_HEADER_MAX];
	uint8		u8FieldSize;
	uint8		u8State;
}tstrHTTPRespHeaderField;

typedef struct{
	tstrHTTPRespHeaderField strHttpHdrField;
