...
/*
	...
	AT+
		...
		WPS_DIS
		GROWL_SEND=5[ID, APP_NAME, EVENT_NAME, DECREPTION_NAME, SSL_CONNECTION] //-> ID and SSL_CONNECTION are 1Byte(0-3:PROWL, 4-7:NMA)
		NMA=5[ID, APP_NAME, EVENT_NAME, DECREPTION_NAME, SSL_CONNECTION]
		PROWL=5[ID, APP_NAME, EVENT_NAME, DECREPTION_NAME, SSL_CONNECTION]
		GROWL_DEINIT
		GROWL_INIT
