...
/*
*/
#define M2M_DATA_SEC_API
#define M2M_SHARED_SEC_API
...
#define AES_CBC_DEC											AES_CbcDec
#define AES_CBC_ENC											AES_CbcEnc
#define BI_DIVIDE											BI_Divide
#define AES_SETUP											aes_setup
#define AES_ENCRYPT											aes_encrypt
#define AES_DECRYPT											aes_decrypt
#define AES_CBC_ENC_SW										AES_CbcEncSW
#define AES128_CBC_Enc_HW(pu8IV, pu8Data, D, pu8Key)
#define AES128_CBC_Dec_HW(pu8IV, pu8Data, D, pu8Key)
#define AES128_CTR_Enc_HW(A, B, C, D)
...
void *scratch_mem_alloc(UWORD16 size);
